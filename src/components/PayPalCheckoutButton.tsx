// --- DISABLED: PayPal (kept for reference) ---
// Replaced by Dodo Payments (see src/config/dodo.ts and
// src/components/Checkout.tsx). To restore, re-enable this component, wire
// it back into Checkout.tsx's INTL branch, and restore VITE_PAYPAL_CLIENT_ID
// in vite-env.d.ts / .env.example / .env.
//
