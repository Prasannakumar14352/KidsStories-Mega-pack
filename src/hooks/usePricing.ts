// --- DISABLED: usePricing / IP geolocation (kept for reference) ---
// No longer needed for gateway choice - Dodo Payments (a Merchant of Record)
// auto-detects location/currency/payment methods on its own hosted page. See
// src/config/dodo.ts and src/components/Checkout.tsx. To restore, re-enable
// this file and src/config/region.ts, then wire Checkout.tsx back to them.
//
...
//   };
// }
// --- END DISABLED: usePricing / IP geolocation ---
