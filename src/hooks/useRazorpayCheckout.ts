// --- DISABLED: Razorpay (kept for reference) ---
// Replaced by Dodo Payments (see src/config/dodo.ts and
// src/components/Checkout.tsx). To restore, re-enable this hook, wire it
// back into Checkout.tsx, and restore VITE_RAZORPAY_PAYMENT_PAGE_URL in
// vite-env.d.ts / .env.example / .env.
//
